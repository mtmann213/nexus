# Project Nexus: 4-Agent Final Roster (2026)
...
## [Tier 1] Dispatcher: @.opencode/agent/dispatcher.md (google/gemma-3-4b)
...
## [Tier 2] Lead Developer: @.opencode/agent/lead-developer.md (qwen/qwen3.5-9b)
...
## [Tier 3] Auditor (Technical Logic): @.opencode/agent/auditor.md (mistralai_mistral-small-3.2-24b-instruct-2506)
...
## [Tier 4] Senior Architect: @.opencode/agent/senior-architect.md (qwen/qwen3.5-35b-a3b)
- **Placement:** System RAM (64GB)
...
- **State File:** `STATE.md` (Shared blackboard for agents).
